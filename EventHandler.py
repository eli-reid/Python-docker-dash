...
from types import MethodType, FunctionType, Union 
...
class EventHandler():
    ...
    @classmethod
    def on(cls, event: str, func: FunctionType or MethodType) -> None:
        ...
        if not isinstance(event, str):
            raise TypeError("event should of type str ")
        elif not isinstance(func, (MethodType, FunctionType)):
            raise TypeError("Requires callback function pointer ex: myCallback(sender, obj)")
        else:
            cls._register(event)
    ...
    @classmethod
    def removeFunc(cls, event: str, func: FunctionType or MethodType) -> None:
    ...
    @classmethod
    def register(cls, event: str) -> None:
...
class Event():
    ...
    def add(self, func: FunctionType or MethodType) -> None:
    ...
    def remove(self, func: FunctionType or MethodType) -> None:
